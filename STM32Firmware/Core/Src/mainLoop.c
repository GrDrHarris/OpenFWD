...
struct MotorController {
...
} motorControlers[2] = {
    {
        ...
        .mode = MODE_DIRECT, .reportAngle = true, .id = 1,
        ...
        .angle = 0, .last_angle = 0, .speed = 0, .last_speed = 0, .target = 0, .integral = 0,
        .Kp = 10, .Ki = 1, .Kd = 0, .Div = 3,
        .mode = MODE_DIRECT, .reportAngle = true, .id = 2,
...
struct RudderController {
    ...
    {{&htim1, TIM_CHANNEL_1, 100}, {RUD1_P_GPIO_Port, RUD1_P_Pin}},
    {{&htim2, TIM_CHANNEL_2, 100}, {RUD2_P_GPIO_Port, RUD2_P_Pin}},
    {{&htim2, TIM_CHANNEL_1, 100}, {RUD3_P_GPIO_Port, RUD3_P_Pin}},
    {{&htim1, TIM_CHANNEL_2, 100}, {RUD4_P_GPIO_Port, RUD4_P_Pin}},
    {{&htim1, TIM_CHANNEL_3, 100}, {RUD5_P_GPIO_Port, RUD5_P_Pin}},
    {{&htim1, TIM_CHANNEL_4, 100}, {RUD6_P_GPIO_Port, RUD6_P_Pin}}
};
